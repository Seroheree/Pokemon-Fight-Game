class shot{
    ...
    doDamage(){
        ...
        let ballWidth=this.newball.getBoundingClientRect().width
    ...
    switch(kpress.keyCode){
        ...
        case 68:
            ...
            case 13:
                ...
                let update=document.querySelector('.CharBullet')

                if(charizard.classList.contains('range-attack-delay') || update.textContent==='0'){
                    if(window.event.keyCode=13) return false
                        ...
                        charizard.classList.add('range-attack-delay')
                    }

                    setTimeout(() => {
                        charizard.classList.remove('range-attack-delay')
                    }, 500)
                ...
                {
                    charizard_start_ammo--
                    update.innerHTML=charizard_start_ammo
                }
...
manual.addEventListener('mouseover',()=>{
    const char=document.querySelector('.CharManual')
    const geng=document.querySelector('.GengManual')


    char.style.display="block"
    geng.style.display="block"
})

manual.addEventListener('mouseout',()=>{
